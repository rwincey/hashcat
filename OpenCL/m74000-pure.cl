...
KERNEL_FQ KERNEL_FA void m74000_init (KERN_ATTR_TMPS (generic_io_tmp_t))
{
...
KERNEL_FQ KERNEL_FA void m74000_loop (KERN_ATTR_TMPS (generic_io_tmp_t))
{
}

KERNEL_FQ KERNEL_FA void m74000_comp (KERN_ATTR_TMPS (generic_io_tmp_t))
{
  /**
   * base
   */
