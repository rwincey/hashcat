...
static const char *HASH_NAME      = "Apache Shiro 1 SHA-256";
static const u64   KERN_TYPE      = 12175;
...
static const char *SIGNATURE_SHIRO1_SHA256 = "$shiro1$SHA-256$";

u64 module_tmp_size (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED const user_options_t *user_options, MAYBE_UNUSED const user_options_extra_t *user_options_extra)
{
  const u64 tmp_size = (const u64) sizeof (shiro1_sha256_tmp_t);
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  token.signatures_buf[0] = SIGNATURE_SHIRO1_SHA256;
